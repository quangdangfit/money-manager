...
public class DatabaseHandler {
    ...
    public ArrayList<ThongKe> getloggiaodichThongkehomnay(String phanloai) {
        ...
        if (cursor.moveToFirst()) {
            do {
                ...
                thongke.setSotien(cursor.getString(cursor.getColumnIndex(COLUM_SOTIEN)) + " VNĐ");
    ...
    public ArrayList<String> getlogTienThongkehomnay(String phanloai) {
        ArrayList<String> listTien = new ArrayList<String>();
        ...
        if (cursor.moveToFirst()) {
            do {
                listTien.add(cursor.getString(cursor.getColumnIndex(COLUM_SOTIEN)));
            } while (cursor.moveToNext());
        }
        cursor.close();
    ...
    public ArrayList<String> getlogTienThongkethangnay(String phanloai) {
        ArrayList<String> listTien = new ArrayList<String>();
    ...
    public ArrayList<String> getlogTienThongkenamnay(String phanloai) {
        ArrayList<String> listTien = new ArrayList<String>();
    ...
    public List<String> getlognam(String phanloai) {
        List<String> names = new ArrayList<String>();
        String selectQuery = "SELECT  phanhom FROM giaodich WHERE nam = '2017'";
