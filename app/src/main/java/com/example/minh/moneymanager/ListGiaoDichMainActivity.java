...
public class ListGiaoDichMainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        for (int i = 0; i < db.lichsugiaodich().size(); i++) {
            ...
            contacts.setSotien(db.lichsugiaodich().get(i).getSotien() + " VNĐ");
...
//                        XemGiaoDichActivity.class);
//                intent.putExtra("Vi", db.lichsugiaodich().get(i).getTaikhoan());
//                intent.putExtra("SoTien", db.lichsugiaodich().get(i).getSotien());
//                intent.putExtra("Nhom", db.lichsugiaodich().get(i).getPhanloai());
//                intent.putExtra("Ngay", db.lichsugiaodich().get(i).getTime());
//
//                intent.putExtra("ahihi", db.lichsugiaodich().get(i).getTaikhoan());
//                finish();
